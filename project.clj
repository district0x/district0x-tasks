(defproject district0x-tasks "1.0.0"
  :description "Voting Dapp to assign project work to contractors"
  ...
  :dependencies [[camel-snake-kebab "0.4.0"]
                 ...
                 [district0x/district-ui-component-form "0.1.9-SNAPSHOT"]
                 [medley "1.0.0"]
                 [mount "0.1.12"]
  ...
  :aliases {"clean-prod-server" ["shell" "rm" "-rf" "server"]
            ...
            "test" ["do" ["build-tests"] ["shell" "node" "district0x-tasks-tests/district0x-tasks-server-tests.js"]]
  ...
  :garden {:builds [{:id "screen"
                     :source-paths ["src"]
                     :stylesheet district0x-tasks.styles.core/main
  ...
  :cljsbuild {:builds [{:id "dev-server"
                       ...
                       {:id "server"
                        ...
                        :compiler {:main "district0x-tasks.server.core"
                                   ...
                                   :source-map "server/district0x-tasks.js.map"
